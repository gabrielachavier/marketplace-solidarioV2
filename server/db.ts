...
/**
 * Criar uma nova submissão de contato
 */
...
/**
 * Obter todas as submissões de contato
 */
export async function getContactSubmissions() {
  ...
  return await db.select().from(contactSubmissions).orderBy((t) => t.createdAt);
}

/**
 * Obter uma submissão de contato por ID
 */
...
/**
 * Atualizar o status de uma submissão de contato
 */
